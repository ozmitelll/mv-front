    ...
    return (
        <div
            ...
            <div className={'w-full flex flex-col items-start justify-center py-8 gap-6'}>
                ...
                <p className={'text-4xl font-semibold'}>Interpretation and Definitions</p>
                <p className={'text-3xl font-semibold'}>Interpretation</p>
                ...
                <p className={'text-3xl font-semibold'}>Definitions</p>
                <p>For the purposes of this Privacy Policy:</p>
                <div className={'flex flex-col gap-4 xl:pl-6 lg:pl-6 pl-2'}>
                    <li><span className={'font-bold'}>Account </span>means a unique account created for You to access
                        our
                        Service or parts of our Service.
                    </li>
                    <li><span className={'font-bold'}>Affiliate</span> means an entity that controls, is controlled by
                        or is
                    ...
                    <li><span className={'font-bold'}>Application </span> refers to M&V Coin, the software program
                        provided
                        by the Company.
                    </li>
                    <li><span className={'font-bold'}>Company</span> (referred to as either "the Company", "We", "Us" or
                        "Our" in this Agreement) refers to M&V Coin.
                    </li>
                    <li><span className={'font-bold'}>Country</span> refers to: Ukraine</li>
                    <li><span className={'font-bold'}>Device</span> means any device that can access the Service such as
                        a
                        computer, a cellphone or a digital tablet.
                    </li>
                    <li><span className={'font-bold'}>Personal Data</span> is any information that relates to an
                        identified
                        or identifiable individual.
                    </li>
                    <li><span className={'font-bold'}>Service</span> refers to the Application.</li>
                    <li><span className={'font-bold'}>Service Provider</span> means any natural or legal person who
                        ...
                        Company,
                        to perform services related to the Service or to assist the Company in analyzing how the Service
                        is
                        used.
                    </li>
                    <li><span className={'font-bold'}>Third-party Social Media Service</span> refers to any website or
                        any
                        social network website through which a User can log in or create an account to use the Service.
                    </li>
                    <li><span className={'font-bold'}>Usage Data</span> refers to data collected automatically, either
                        generated by the use of the Service or from the Service infrastructure itself (for example, the
                        duration of a page visit).
                    </li>
                    <li><span className={'font-bold'}>You</span> means the individual accessing or using the Service, or
                        the company, or other legal entity on behalf of which such individual is accessing or using the
                        Service, as applicable.
                    </li>
                </div>
                <p className={'text-4xl font-semibold'}>Collecting and Using Your Personal Data</p>
                <p className={'text-3xl font-semibold'}>Types of Data Collected</p>
                ...
                <p className={'text-2xl font-semibold'}>Usage Data</p>
                ...
                <p className={'text-2xl font-semibold'}>Information from Third-Party Social Media Services</p>
                ...
                <p className={'text-2xl font-semibold'}>Information Collected while Using the Application</p>
                ...
                <p className={'text-3xl font-semibold'}>Use of Your Personal Data</p>
                <p>The Company may use Personal Data for the following purposes:</p>
                <div className={'flex flex-col gap-4 xl:pl-6 lg:pl-6 pl-2'}>
                    <li><span className={'font-bold'}>To provide and maintain our Service</span>, including to monitor
                        the usage of our Service.
                    </li>
                    <li><span className={'font-bold'}>To manage Your Account:</span> to manage Your registration as a
                    ...
                    <li><span className={'font-bold'}>For the performance of a contract:</span> the development,
                        compliance and undertaking of the purchase contract for the products, items or services You have
                        purchased or of any other contract with Us through the Service.
                    </li>
                    <li><span className={'font-bold'}>To contact You:</span> To contact You by email, telephone calls,
                    ...
                    <li><span className={'font-bold'}>To provide You</span> with news, special offers and general
                    ...
                    <li><span className={'font-bold'}>To manage Your requests:</span> To attend and manage Your requests
                        to Us.
                    </li>
                    <li><span className={'font-bold'}>For business transfers:</span> We may use Your information to
                    ...
                    <li><span className={'font-bold'}>For other purposes:</span> We may use Your information for other
                ...
                <div className={'flex flex-col gap-4 xl:pl-6 lg:pl-6 pl-2'}>
                    <li><span className={'font-bold'}>With Service Providers:</span> We may share Your personal
                        information with Service Providers to monitor and analyze the use of our Service, to contact
                        You.
                    </li>
                    <li><span className={'font-bold'}>For business transfers:</span> We may share or transfer Your
                    ...
                    <li><span className={'font-bold'}>With Affiliates:</span> We may share Your information with Our
                    ...
                    <li><span className={'font-bold'}>With business partners:</span> We may share Your information with
                        Our business partners to offer You certain products, services or promotions.
                    </li>
                    <li><span className={'font-bold'}>With other users:</span> when You share personal information or
                    ...
                    <li><span className={'font-bold'}>With Your consent:</span> We may disclose Your personal
                        information for any other purpose with Your consent.
                    </li>
                </div>
                <p className={'text-3xl font-semibold'}>Retention of Your Personal Data</p>
                ...
                <p className={'text-3xl font-semibold'}>Transfer of Your Personal Data</p>
                ...
                <p className={'text-3xl font-semibold'}>Delete Your Personal Data</p>
                ...
                <p className={'text-3xl font-semibold'}>Disclosure of Your Personal Data</p>
                <p className={'text-2xl font-semibold'}>Business Transactions</p>
                ...
                <p className={'text-2xl font-semibold'}>Law enforcement</p>
                <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required
                    ...
                    agency).</p>
                <p className={'text-2xl font-semibold'}>Other legal requirements</p>
                ...
                <p className={'text-3xl font-semibold'}>Security of Your Personal Data</p>
                <p>The security of Your Personal Data is important to Us, but remember that no method of transmission
                    ...
                    security.</p>
                <p className={'text-4xl font-semibold'}>Children's Privacy</p>
                ...
                <p>If We need to rely on consent as a legal basis for processing Your information and Your country
                    ...
                    information.</p>
                <p className={'text-4xl font-semibold'}>Links to Other Websites</p>
                ...
                <p className={'text-4xl font-semibold'}>Changes to this Privacy Policy</p>
                ...
                <div className={'flex flex-col gap-4 xl:pl-6 lg:pl-6 pl-2'}>
                    <li>By email: dimmaa9@icloud.com</li>
                </div>
            </div>
